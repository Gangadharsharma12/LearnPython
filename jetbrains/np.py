...
# Hello sir..I wrote a code based on Classes and functions.Please check the code and let me know if any modifications can be done

# write a python program which will accept student details such as student number,student name,student marks in 3 subjects.
# calculate the percentage and give the grades.
#
# Give the grade = "Fail" provided student secured less than 40 in any of the three subjects
# Give the grade = "Destinction" provided total marks lies within 250 and 300
# Give the grade = "First" provided total marks lies within 200 and 249
# Give the grade = "second" provided total marks lies within 150 and 199
# Give the grade = "third" provided total marks lies within 120 and 149
# save the student result in student table of database
